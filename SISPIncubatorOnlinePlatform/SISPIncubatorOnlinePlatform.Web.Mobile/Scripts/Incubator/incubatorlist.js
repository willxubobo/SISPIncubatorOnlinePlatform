...
function GetHtml(data) {
    ...
    for (i = 0; i < data.length; i++) {
        ...
        if (mm < 2) {
            ...
            htmlItem += "<td><a class=\"businessListDiv\" onclick=\"OpenInucubatorInfo('" + data[i].incubatorID + "')\" href=\"#\"><div class=\"businessPicDiv\">";
            htmlItem += "  <div class=\"businessPicInfoBox\"> <div class=\"businessPic\">";
            htmlItem += " <img src='" + newLog + "'  /> </div><div class=\"businessPicTxt\">";
            htmlItem += "<p class=\"businessTitle\">" + data[i].incubatorName + "</p><p class=\"businessTitleTxt\">" + data[i].description + "</p></div></div></div></a></td>";
            if (mm == 1) {
                html = "<tr>" + htmlItem + "</tr>";
...
function OpenInucubatorInfo(id) {
    window.location.href = 'incubatorinfo.html?id=' + id + '&' + MathRand(6);
}
